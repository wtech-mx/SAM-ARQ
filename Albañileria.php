...
?>  
   ...
   style="background-image: url('img/ladrillos.jpg');
  min-height: 500px; 
  ...
  <div class="whole-wrap">
    <div class="container box_1170">
      <div class="section-top-border">
        <h3 class="mb-30">Albañilería</h3>
        <div class="row">
          <div class="col-md-3">
            <img src="img/icon-albañilaria.png" alt="" class="img-fluid">
          </div>
          <div class="col-md-9 mt-sm-20">
            <p style="font-size: 20px">Nuestros técnicos están capacitados para solucionar cualquier trabajo requerido, acabados, muros y falso plafón, desde lo más simple hasta lo más complejo.</p>

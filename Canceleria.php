...
?>  
   ...
   style="background-image: url('img/canceleria.jpg');
  min-height: 500px; 
  ...
  background-size: cover;">
        ...
        <h3 style="color: #0d193a;"><strong>Soluciones integrales</strong>  <br>para tu hogar, comercio y oficina
        </h3>
                 ...
                 <div class="dropdown show">
                    ...
                    <a class="dropdown-item" href="Ecotecnias.php">Ecotecnias</a>                    <!--<a class="dropdown-item" href="contacto.php">Conacto</a>-->
                    </div>
                </div>
    </div>
  ...
  <div class="whole-wrap">
    <div class="container box_1170">
      <div class="section-top-border">
        <h3 class="mb-30">Canceleria</h3>
        <div class="row">
          <div class="col-md-3">
            <img src="img/icon-canceleria.png" alt="" class="img-fluid">
          </div>
          <div class="col-md-9 mt-sm-20">
            <p>Nuestros técnicos están capacitados para solucionar cualquier trabajo requerido, formas, colores y sensaciones encontraras con nuestros diseños.</p>

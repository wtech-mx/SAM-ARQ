...
?>  
   ...
   style="background-image: url('img/carpinteria.jpg');
  min-height: 500px; 
  ...
  ">
        <h3 style=""><strong>Soluciones integrales</strong>  <br>para tu hogar, comercio y oficina
        </h3>
	...
	<div class="whole-wrap">
		<div class="container box_1170">
			<div class="section-top-border">
				<h3 class="mb-30">Carpintería</h3>
				<div class="row">
					<div class="col-md-3">
						<img src="img/icon-carpinteria.png" alt="" class="img-fluid">
					</div>

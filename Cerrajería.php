...
?>  
   ...
   style="background-image: url('img/cerrajeria.jpg');
  min-height: 500px; 
	...
	<div class="whole-wrap">
		<div class="container box_1170">
			<div class="section-top-border">
				<h3 class="mb-30">Cerrajería</h3>
				<div class="row">
					<div class="col-md-3">
						<img src="img/icono_cerrajero.png" alt="" class="img-fluid">
					</div>
					<div class="col-md-9 mt-sm-20">
						<p style="font-size: 20px;">Te asesoramos para mejorar la seguridad de tu hogar, negocio o empresa.</p>

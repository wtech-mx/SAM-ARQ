...
?>  
   ...
   style="background-image: url('img/electricista.jpg');
  min-height: 500px; 
  background-attachment: fixed;
  background-position: center;
  background-repeat: no-repeat;
  background-size: cover;">
        <h3 style="color: #00AAFF;"><strong>Soluciones integrales</strong>  <br>para tu hogar, comercio y oficina
        </h3>
	...
	<div class="whole-wrap">
		<div class="container box_1170">
			<div class="section-top-border">
				<h3 class="mb-30">Electricista</h3>
				<div class="row">
					<div class="col-md-3">
						<img src="img/icon-luz.png" alt="" class="img-fluid">
					</div>
					<div class="col-md-9 mt-sm-20">
						<p style="font-size: 20px;">Te ayudamos a resolver todos los problemas de la instalación eléctrica en tu casa, comercio u oficina</p>

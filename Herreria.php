...
?>  
   ...
   style="background-image: url('img/herreria.jpg');
  min-height: 500px; 
	...
	<div class="whole-wrap">
		<div class="container box_1170">
			<div class="section-top-border">
				<h3 class="mb-30">Herrería</h3>
				<div class="row">
					<div class="col-md-3">
						<img src="img/icon-herreria.png" alt="" class="img-fluid">
					</div>
					<div class="col-md-9 mt-sm-20">
						<p style="font-size: 20px;"><strong></strong> <br>
Sabemos que  la protección y el diseño no están peleados. </p>

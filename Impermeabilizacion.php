...
?>  
   ...
   style="background-image: url('img/impermeabilización.jpg');
  min-height: 500px; 
	...
	<div class="whole-wrap">
		<div class="container box_1170">
			<div class="section-top-border">
				<h3 class="mb-30">Impermeabilizacion</h3>
				<div class="row">
					<div class="col-md-3">
						<img src="img/icon-Impermeabilización.png" alt="" class="img-fluid">
					</div>
					<div class="col-md-9 mt-sm-20">
						<p style="font-size: 20px;">Nuestros técnicos están capacitados para solucionar cualquier trabajo requerido, <br> ¿sabías que hay un sistema de impermeabilización para cada zona de tu casa?</p>

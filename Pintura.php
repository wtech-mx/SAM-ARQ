  ...
  <div class="whole-wrap">
    <div class="container box_1170">
      <div class="section-top-border">
        <h3 class="mb-30">Pintura</h3>
        <div class="row">
          <div class="col-md-3">
            <img src="img/icon-pintura.svg" alt="" class="img-fluid">
          </div>
          <div class="col-md-9 mt-sm-20">
            <p style="font-size: 20px;">Te ayudamos a dar ese toque de calidez que necesita tu casa, comercio u oficina.</p>

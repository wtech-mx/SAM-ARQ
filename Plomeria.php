...
?>  
   ...
   style="background-image: url('img/plomeria.jpg');
  min-height: 500px; 
	...
	<div class="whole-wrap">
		<div class="container box_1170">
			<div class="section-top-border">
				<h3 class="mb-30">Plomería</h3>
				<div class="row">
					<div class="col-md-3">
						<img src="img/icon-plomeria.png" alt="" class="img-fluid">
					</div>
					<div class="col-md-9 mt-sm-20">
						<p style="font-size: 20px;">Nuestros técnicos están capacitados para solucionar cualquier trabajo requerido, <br> desde la reparación de una fuga de agua/gas, hasta proyectos de instalaciones hidrosanitarias.</p>
